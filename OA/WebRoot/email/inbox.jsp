					...
					<s:form id="form" action="email/getemail" method="post">
						...
						<table width="100%" border="0" cellpadding="0" cellspacing="1"
							...
							<tr>
								...
								<td width="21%" height="20" bgcolor="d3eaef" class="STYLE6">
									<div align="center">
							...
							<s:iterator value="#request.userEmails" var="userEmail">
								<tr>
									...
									<td height="20" bgcolor="#FFFFFF" class="STYLE19"
										align="center">
										<s:if test="#userEmail.isread == true">
											<s:property value="#userEmail.id.email.isread" />
									...
									<td height="20" bgcolor="#FFFFFF" class="STYLE19"
										align="center">
										<s:a
											href="email/viewEmail?userEmail.id.email.emailid=%{#userEmail.id.email.emailid}&userEmail.type=2&userEmail.isread=%{#userEmail.isread}">查看</s:a>
										<s:a
