...
function delquestion() {
	...
	<body>
		<table width="100%" border="0" align="center">
			...
			<s:form
				action="questionnaire/selectQuestionnaire!selectNaireQuestion"
			...
			<tr>
				<td align="right">
					<a
						href="<%=path%>/question/selectQuestions!editQuestionnaireQueations?questionnaireid=<s:property value="questionnaire.qid" />">添加题目</a>
					...
					<table width="100%" border="0">
						...
						<s:iterator value="questionlist" var="questionoption" step="i">
							<TR>
								...
								<td width="3%" bgcolor="d3eaef" class="STYLE6">
									<a
										href="<%=path%>/questionnaire/editQuestionnaire!delQuestionnaire?questionnaireid=<s:property value="questionnaire.qid" />&quesid=<s:property value="#questionoption[0].questionId"/>"
										onclick="return confirm('是否删除该题目？')"><img
											src="questionnaire/images/del.gif" width="10" height="10" />
									</a>
								</td>
							</TR>
							<tr>
