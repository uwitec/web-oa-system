					...
					<td>
						<table width="100%">
							<tr>
								...
								<td>
									<s:textfield name="questionnaire.qname" size="50"
										onblur="checkqname()"></s:textfield>
									<span id="sqname"></span>
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td>
									<SCRIPT type="text/javascript">
								     ...
								     var datepicker = dojo.widget.byId("stop");  
								     dojo.event.connect(datepicker, "onValueChanged", myCallback );  
								 } 
								function myCallback(){
								    var sdt = dojo.widget.byId("start").getValue();
								    var edt = dojo.widget.byId("stop").getValue();
								   
								   
								    if(sdt>edt){
								        dojo.widget.byId("stop").setValue(sdt);
								    }
								}  
							...
							<tr>
								...
								<td>
									<s:textarea cols="50" rows="5" name="questionnaire.explain"
										onblur="checkexplain()"></s:textarea>
